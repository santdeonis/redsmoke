...
return [
    ...
    [
        'section-check-tour' => [
            'count-tours' => 'Нельзя выбрать родительским раздел, в котором уже есть туры.',
        ],
        'tour-check-section-relation-rule' => [
            'section-parent' => 'Нельзя добавить тур в главный раздел.',
            'section-children' => 'Раздел не должен содержать дочерних разделов.',
        ],
        'zip-check-index' => [
            'must-upload-index' => 'В загружаемом архиве должен содержаться файл index.html',
            'upload-zip-error' => 'Не удалось загрузить архив',
        ]
    ]
];
